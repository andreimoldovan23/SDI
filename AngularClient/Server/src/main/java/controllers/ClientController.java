...
public class ClientController {
    ...
    public List<ClientDTO> filterClients(@RequestParam(name = "name") String name) {
        return clientService.filterClientsByName(name).stream()
    ...
    public List<ClientDTO> filterClientsByAge(@RequestParam(name = "age1") String age1,
                                              @RequestParam(name = "age2") String age2) {
