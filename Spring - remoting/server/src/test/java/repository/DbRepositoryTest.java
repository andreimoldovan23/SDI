...
public class DbRepositoryTest {
    ...
    @Autowired
    private DBRepo<Integer, Address> addressDBRepo;

    @Autowired
    private DBRepo<Integer, Client> clientDBRepo;

    @Autowired
    private DBRepo<Integer, Coffee> coffeeDBRepo;

    @Autowired
    private DBRepo<Pair<Integer, Integer>, Order> orderDBRepo;
    ...
    public void tearDown() {
        ...
        orderDBRepo.deleteTable();
        coffeeDBRepo.deleteTable();
        clientDBRepo.deleteTable();
