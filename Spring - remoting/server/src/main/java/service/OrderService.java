...
public class OrderService  extends Service<Pair<Integer, Integer>, Order> implements IOrderService {
         ...
         */
        public void buyCoffee(Integer id, Integer clientId, Integer coffeeId) throws ValidatorException {
         ...
         */
        public void changeStatus(Integer ordId, Integer clientId, Status status) throws ValidatorException {
         ...
         */
        public void deleteCoffeesFromOrder(Integer ordId, Integer clientId, List<Integer> coffeesId) throws ValidatorException {
                this.repository.findOne(new ImmutablePair<>(ordId, clientId))
                        .ifPresentOrElse(ord -> {
         ...
         */
        public void addCoffeesToOrder(Integer ordId, Integer clientId, List<Integer> coffeesId) throws ValidatorException {
                this.repository.findOne(new ImmutablePair<>(ordId, clientId))
                        .ifPresentOrElse(ord -> {
                            ord.getCoffeesId().addAll(coffeesId);
                            try {
